...
@section("content")
    ...
    <main class="h-lvh content-center grid lg:grid-cols-[2fr,1.5fr]">
        <h1 class="text-center text-3xl font-bold text-gray-500 m-auto">Welcome Home, Update User</h1>
        <form class="w-5/6 shadow-lg p-5 m-auto" action="{{route("postUpdate")}}" method="POST">
            @csrf
            <div class="mb-6">
                <input name="user_name"
                       class="border-b-2 border-gray-200 w-full py-2 p text-gray-700 leading-tight focus:outline-none focus:bg-white"
